...
export default function HomePage() {
  return (
    <div>
      ...
      <div className="flex justify-center px-8 pt-16 md:pt-32 mask-b-from-50% mask-b-to-98%">
        <Logo className="h-[clamp(15vw,30vw,24rem)] fill-fn-300" />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="bg-(image:--background-grid)">
      <div className="px-4 sm:px-8 bg-gradient-to-b from-transparent from-50% to-fn-950">
        <div className="relative overflow-hidden pb-24 md:pb-32 pt-24 md:pt-40 border-x border-b border-fn-800 bg-fn-950 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center text-center relative z-1 px-8">
            <h1 className="text-4xl md:text-5xl lg:text-7xl mb-6 text-balance">
              More than just file uploads{" "}
              <FolderOpen className="inline-block size-10 md:size-12 lg:size-18 align-bottom" />
            </h1>
...
const Cards = () => {
  return (
    <div className="border-x border-fn-800 md:px-16 grid lg:grid-cols-3 lg:gap-4 max-lg:divide-y divide-fn-800">
      <div className="px-8 py-8 lg:py-16 md:border-x border-fn-800 bg-gradient-to-tl from-fn-900 to-fn-950">
...
const Integrations = () => {
  return (
    <div className="relative overflow-hidden p-8 md:p-16 border border-fn-800">
...
/>`
  ...
  return (
    <div className="grid md:grid-cols-2 border-b border-fn-800">
      <div className="py-8 md:py-16 px-8 border-x border-fn-800">
      ...
      <div className="md:pt-16 pl-8 border-r max-md:border-l border-fn-800 max-w-[calc(100vw-2rem)]">
