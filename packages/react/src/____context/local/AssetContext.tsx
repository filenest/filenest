...
import { useAssetDeleteAction } from "../../____utils/useAssetDeleteAction"
...
export const AssetProvider = ({
    ...
    const { alertDialog, updateAsset, _l, fetchers, onAssetSelect, selectedFiles } =
        useGlobalContext()
    ...
    const isSelected = useMemo(
        () => selectedFiles.some((a) => a.assetId === asset.assetId),
        [selectedFiles, asset]
    )
    ...
    async function renameAsset(updateDeliveryUrl?: boolean) {
        ...
        try {
            ...
            if (result.success) {
                updateAsset(asset.assetId, (curr) => ({
                    ...curr,
                    name: newName,
                    isLoading: false,
                }))
