...
import { createFetchers } from "../../____utils/fetchers"
import { labels } from "../../____utils/labels"
import { useDebouncedState } from "../../____utils/useDebouncedState"
import {
    useInfiniteQuery,
...
import type { AssetExtraProps, SetState } from "../../____utils/types"
import type { RootProps } from "../../____components/Root"
...
export const useGlobalContext = () => {
    ...
    if (!context) {
        throw new Error(
            "A Filenest component must be used within a Filenest.Root component."
        )
    }
    return context
}
...
export const GlobalProvider = ({ children, ...props }: GlobalProviderProps) => {
    ...
    function updateAsset(
        ...
        setData((prev) => {
            ...
            const newAssets = currentAssets.map((a) =>
                a.assetId === assetId ? { ...a, ...updatedData } : a
            )
            return {
                ...prev,
                resources: {
    ...
    const [alertDialogContent, _setAlertDialogContent] = useState<
        Partial<AlertDialogContent>
    >({
        title: "",
        text: "",
