...
export const AlertDialog = ({ children, ...props }: Primitive.AlertDialogProps) => {
    ...
    return (
        ...
        >
            <Primitive.Portal>{children}</Primitive.Portal>
        </Primitive.Root>
    )
}
...
export const AlertDialogText = ({ className }: { className?: string }) => {
    const { alertDialog } = useGlobalContext()
    return <p className={className}>{alertDialog.content.text}</p>
}

export const AlertDialogOverlay = ({
    children,
    ...props
}: Primitive.AlertDialogOverlayProps) => {
...
export const AlertDialogContent = ({
    ...
    return <Primitive.Content {...props}>{children}</Primitive.Content>
}

export const AlertDialogCancel = ({
    children,
    ...props
}: Primitive.AlertDialogCancelProps) => {
    const { alertDialog } = useGlobalContext()
    ...
    return <Primitive.Cancel {...props}>{getChildren()}</Primitive.Cancel>
}

export const AlertDialogAction = ({
    children,
    ...props
}: Primitive.AlertDialogActionProps) => {
    const { alertDialog } = useGlobalContext()
