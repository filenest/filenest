...
import type { WithoutChildren } from "../____utils/types"
import { Slot } from "@radix-ui/react-slot"
import {
    UploaderProvider,
    useUploaderContext,
    type UploaderProviderProps,
} from "../____context/local/UploaderContext"
...
export interface UploaderProps
    extends WithoutChildren<
        Omit<React.ComponentPropsWithoutRef<"div">, "onProgress" | "onError">
    > {
    asChild?: boolean
...
const Uploader = ({
    ...
    const isHidden =
        (hideIfMaxFilesReached && maxFiles && getUploaderFiles(id).length >= maxFiles) ||
