...
import { FolderContext } from "../____context/local/FolderContext"
import { AssetContext } from "../____context/local/AssetContext"
...
export const useResourceName = () => {
    ...
    if (folderCtx && !assetCtx) {
        ...
        throw new Error(
            "Filenest.ResourceName must be used within a Filenest.Folder or Filenest.Asset component"
        )
    }
